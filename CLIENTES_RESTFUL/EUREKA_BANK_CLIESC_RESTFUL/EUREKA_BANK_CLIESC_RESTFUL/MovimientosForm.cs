...
namespace EUREKA_BANK_CLIESC_RESTFUL
{
    public partial class MovimientosForm : Form
    {
        ...
        private async void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                dgvMovimientos.Rows.Add(i + 1, movimientos[i].Fecha.ToString("yyyy-MM-dd HH:mm:ss"), movimientos[i].Tipo, movimientos[i].Accion, movimientos[i].Importe.ToString("N2"));
            }
