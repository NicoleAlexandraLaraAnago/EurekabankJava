...
CREATE TABLE LOGSESSION (
	...
	CONSTRAINT fk_log_session_empleado FOREIGN KEY (chr_emplcodigo)
...
CREATE TABLE Asignado (
	...
	FOREIGN KEY fk_asignado_empleado (chr_emplcodigo)
		REFERENCES Empleado (chr_emplcodigo),
	FOREIGN KEY fk_asignado_sucursal (chr_sucucodigo)
...
CREATE TABLE Cuenta (
	...
	FOREIGN KEY fk_cuenta_cliente (chr_cliecodigo) REFERENCES Cliente (chr_cliecodigo),
	FOREIGN KEY fk_cuente_empleado (chr_emplcreacuenta) REFERENCES Empleado (chr_emplcodigo),
	FOREIGN KEY fk_cuenta_sucursal (chr_sucucodigo) REFERENCES Sucursal (chr_sucucodigo),
	FOREIGN KEY fk_cuenta_moneda (chr_monecodigo) REFERENCES Moneda (chr_monecodigo)
) ENGINE=INNODB;
...
CREATE TABLE Movimiento (
	...
	FOREIGN KEY fk_movimiento_tipomovimiento (chr_tipocodigo) REFERENCES TipoMovimiento (chr_tipocodigo),
	FOREIGN KEY fk_movimiento_empleado (chr_emplcodigo) REFERENCES Empleado (chr_emplcodigo),
	FOREIGN KEY fk_movimiento_cuenta (chr_cuencodigo) REFERENCES Cuenta (chr_cuencodigo)
) ENGINE=INNODB;
...
CREATE TABLE InteresMensual (
	...
	FOREIGN KEY fk_interesmensual_moneda (chr_monecodigo) REFERENCES Moneda (chr_monecodigo)
) ENGINE=INNODB;
...
CREATE TABLE CostoMovimiento (
	...
	FOREIGN KEY fk_costomovimiento_moneda (chr_monecodigo) REFERENCES Moneda (chr_monecodigo)
) ENGINE=INNODB;
...
CREATE TABLE CargoMantenimiento (
	...
	FOREIGN KEY fk_cargomantenimiento_moneda (chr_monecodigo) REFERENCES Moneda (chr_monecodigo)
) ENGINE=INNODB;
