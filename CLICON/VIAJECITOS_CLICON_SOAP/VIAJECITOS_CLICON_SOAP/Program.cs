    ...
    class Program
    {
        ...
        static void MenuCliente()
        {
            ...
            switch (op)
            {
                ...
                case "4": usuarioActual = null; break;
                default: Console.WriteLine("Opción inválida"); break;
            }
        }
        ...
        static void BuscarVueloMayor()
        {
            ...
            if (vuelo != null)
            {
                ...
                if (opcion == "s")
                {
                    string resultado = service.RegistrarCompra(vuelo.Id, usuarioActual.Id);
                    Console.WriteLine($"\n✅ {resultado}");
                }
                else
                {
        ...
        static void ComprarVuelo()
        {
            ...
            {
                Console.WriteLine($"ID: {v.Id} | Ruta: {v.CiudadOrigen} → {v.CiudadDestino} | Hora: {v.HoraSalida} | Valor: ${v.Valor}");
            }
            ...
            // Validar si el ID existe en la lista de vuelos
            ...
            string resultado = service.RegistrarCompra(idVuelo, usuarioActual.Id);
            Console.WriteLine($"\n✅ {resultado}");
        }
