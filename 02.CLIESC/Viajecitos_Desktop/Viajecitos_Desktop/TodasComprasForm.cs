...
namespace Viajecitos_Desktop
{
    public partial class TodasComprasForm : Form
    {
        ...
        public TodasComprasForm()
        {
            ...
            /* ——— Fondo ——— */
            string ruta = @"C:\Users\Notebook-ASUS\Desktop\VIAJECITOS_SOAP_DOTNET_GR04\02.CLIESC\Viajecitos_Desktop\Viajecitos_Desktop\Resources\2.jpg";
            ...
            /* ——— Estilo de botones y grid ——— */
            Ui.PintarBoton(btnFiltrar);
            Ui.PintarBotonOutline(btnLimpiar);
            Ui.PintarBotonOutline(btnVolver);
            Ui.EstiloGrid(dgCompras);
