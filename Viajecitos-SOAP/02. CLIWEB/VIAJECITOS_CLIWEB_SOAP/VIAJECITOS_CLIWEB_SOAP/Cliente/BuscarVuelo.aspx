        ...
        <div class="form-container">
            ...
            <asp:Panel ID="panelMasCaro" runat="server" Visible="false" CssClass="destacado-panel">
                ...
                <div class="vuelo-mas-caro">
                    ...
                    <asp:TextBox ID="txtCantidadMasCaro" runat="server" Text="1" CssClass="form-control" TextMode="Number" />
            ...
            <asp:Panel ID="panelOtrosVuelos" runat="server" Visible="false">
                ...
                <asp:GridView ID="gvOtrosVuelos" runat="server" AutoGenerateColumns="False" CssClass="grid" OnRowCommand="gvOtrosVuelos_RowCommand" DataKeyNames="Id">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cantidad">
                            <ItemTemplate>
                                <asp:TextBox ID="txtCantidadOtro" runat="server" Text="1" CssClass="form-control" TextMode="Number" Width="60px" />
                            </ItemTemplate>
                        </asp:TemplateField>
