 ...
 * generated in the ec.edu.gr02.servicio package. 
...
public class ObjectFactory {
    ...
    private final static QName _ComprarYFacturar_QNAME = new QName("http://servicio.gr02.edu.ec/", "comprarYFacturar");
    private final static QName _VerHistorialBusquedasResponse_QNAME = new QName("http://servicio.gr02.edu.ec/", "verHistorialBusquedasResponse");
    private final static QName _BuscarVueloPorId_QNAME = new QName("http://servicio.gr02.edu.ec/", "buscarVueloPorId");
    private final static QName _VerHistorialBusquedas_QNAME = new QName("http://servicio.gr02.edu.ec/", "verHistorialBusquedas");
    private final static QName _BuscarVuelosResponse_QNAME = new QName("http://servicio.gr02.edu.ec/", "buscarVuelosResponse");
    private final static QName _ObtenerAmortizacionPorFactura_QNAME = new QName("http://servicio.gr02.edu.ec/", "obtenerAmortizacionPorFactura");
    private final static QName _HistorialFacturasPorUsuarioResponse_QNAME = new QName("http://servicio.gr02.edu.ec/", "historialFacturasPorUsuarioResponse");
    private final static QName _BuscarVueloPorIdResponse_QNAME = new QName("http://servicio.gr02.edu.ec/", "buscarVueloPorIdResponse");
    private final static QName _ObtenerAmortizacionPorFacturaResponse_QNAME = new QName("http://servicio.gr02.edu.ec/", "obtenerAmortizacionPorFacturaResponse");
    private final static QName _BuscarVuelos_QNAME = new QName("http://servicio.gr02.edu.ec/", "buscarVuelos");
    private final static QName _Login_QNAME = new QName("http://servicio.gr02.edu.ec/", "login");
    private final static QName _ComprarYFacturarResponse_QNAME = new QName("http://servicio.gr02.edu.ec/", "comprarYFacturarResponse");
    private final static QName _ObtenerFacturaResponse_QNAME = new QName("http://servicio.gr02.edu.ec/", "obtenerFacturaResponse");
    private final static QName _LoginResponse_QNAME = new QName("http://servicio.gr02.edu.ec/", "loginResponse");
    private final static QName _ObtenerFactura_QNAME = new QName("http://servicio.gr02.edu.ec/", "obtenerFactura");
    private final static QName _HistorialFacturasPorUsuario_QNAME = new QName("http://servicio.gr02.edu.ec/", "historialFacturasPorUsuario");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ec.edu.gr02.servicio
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "comprarYFacturar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "verHistorialBusquedasResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "buscarVueloPorId")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "verHistorialBusquedas")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "buscarVuelosResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "obtenerAmortizacionPorFactura")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "historialFacturasPorUsuarioResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "buscarVueloPorIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "obtenerAmortizacionPorFacturaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "buscarVuelos")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "login")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "comprarYFacturarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "obtenerFacturaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "loginResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "obtenerFactura")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.gr02.edu.ec/", name = "historialFacturasPorUsuario")
