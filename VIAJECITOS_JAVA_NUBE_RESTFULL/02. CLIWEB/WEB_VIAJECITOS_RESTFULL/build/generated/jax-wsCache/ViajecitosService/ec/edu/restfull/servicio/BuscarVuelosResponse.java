 ...
 *       &lt;sequence&gt;
 *         &lt;element name="return" type="{http://servicio.restfull.edu.ec/}vuelo" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class BuscarVuelosResponse {
     ...
     * 
     */
    public List<Vuelo> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Vuelo>();
        }
        return this._return;
    }
